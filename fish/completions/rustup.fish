...
complete -c rustup -n "__fish_seen_subcommand_from install" -l profile -r
...
complete -c rustup -n "__fish_seen_subcommand_from toolchain; and __fish_seen_subcommand_from install" -l profile -r
